...
本仓库基于 Elsevier 官方 els-cas-templates 修改，官方核心模板文件（.cls / .sty）的版权归 Elsevier B.V. 所有，请遵循 Elsevier 的投稿指南使用。

作者原创的自动化脚本（.bat / .ps1）及排版控制逻辑，免费提供给科研人员进行个人学习和学术投稿使用。

代码按"原样"提供，不含任何明示或暗示的保证。因使用本脚本产生的任何投稿格式问题，请最终以期刊官方要求为准。
